...
int d2[5][3]={178,178,178,
                0,0, 178,
                178,178,178,
                178,0,0,
                178,178,178};

int d3[5][3]={178,178,178,
                0, 0, 178,
                178,178,178,
                0, 0,178,
                178,178,178};

int d4[5][3] ={178,0,178,
                178,0, 178,
                178,178,178,
                0, 0,178,
                ' ', ' ',178};

int d5[5][3]={178,178,178,
               178,0,0,
               178,178,178,
               0,0,178,
               178,178,178};

int d6[5][3]={178,178,178,
               178,0,0,
               178,178,178,
               178,0,178,
               178,178,178};

int d7[5][3]={178,178,178,
               0,0,178,
               0,0,178,
               0,0,178,
               0,0,178};

int d8[5][3]={178,178,178,
               178,0,178,
               178,178,178,
               178,0,178,
               178,178,178};

int d9[5][3]={178,178,178,
               178,0,178,
               178,178,178,
               0,0,178,
               0,0,178};
...
void drawBorder(int x=0, int y=0)
{
    ...
    for(int i =1 ;i <=height;i++){
        for(int j=1; j<=width;j++){
            ...
            else if(i==1 && j==height) cout <<h;
            else if(i==1 && j==width )cout<< v;
        }
    }
}
int main()
